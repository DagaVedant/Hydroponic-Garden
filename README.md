...
5. because every module re-collects and re-distributes, **module 6 gets watered like module 1**
...
| **the supply pipe doesn't have to be watertight** | it runs in a dry tunnel through each module, so a leak just drips into the root chamber. same water it was already carrying |
